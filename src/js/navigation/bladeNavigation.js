...
.factory('sdl.management.toolbarService', function () {
...
.directive('vaBladeContainer', ['$compile', 'sdl.management.bladeNavigationService', function ($compile, bladeNavigationService) {
    return {
        restrict: 'E',
        replace: true,
        templateUrl: 'templates/navigation/bladeContainer.tpl.html',
        link: function (scope) {
            scope.blades = bladeNavigationService.stateBlades();
        }
    }
}])
.directive('vaBlade', ['$compile', 'sdl.management.bladeNavigationService', 'sdl.management.toolbarService', '$timeout', '$document', function ($compile, bladeNavigationService, toolbarService, $timeout, $document) {
    return {
        terminal: true,
        priority: 100,
...
.factory('sdl.management.bladeNavigationService', ['authService', '$timeout', '$state', 'sdl.management.dialogService', function (authService, $timeout, $state, dialogService) {
