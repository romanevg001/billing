angular.module('sdl.management')
    .directive('vaBreadcrumb', [
        'sdl.management.breadcrumbHistoryService', function (breadcrumbHistoryService) {
            return {
                restrict: 'E',
                require: 'ngModel',
                replace: true,
        ...
        templateUrl: 'templates/navigation/breadcrumbs.tpl.html',
    ...
    .factory('sdl.management.breadcrumbHistoryService', function () {
        var map = {};
