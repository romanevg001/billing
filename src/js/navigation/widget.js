...
.factory('sdl.management.widgetService', function () {
...
.directive('vaWidgetContainer', ['$compile', '$localStorage', 'sdl.management.widgetService', function ($compile, $localStorage, widgetService) {
    return {
        restrict: 'E',
        replace: true,
        templateUrl: 'templates/navigation/widgetContainer.tpl.html',
        scope: {
            gridsterOpts: '=?',
            group: '@',
            blade: '='
...
.directive('vaWidget', ['$compile', 'sdl.management.widgetService', 'authService', function ($compile, widgetService, authService) {
	return {
		link: function (scope, element, attr) {
