...
.controller('sdl.management.settingGroupListController', ['$injector', '$scope', 'sdl.management.settings', 'sdl.management.bladeNavigationService',
function ($injector, $scope, settings, bladeNavigationService) {
    ...
    blade.refresh = function (disableOpenAnimation) {
        ...
        settings.getList().then(
            function (results) {
            blade.allSettings = results.data;
            settingsTree = {};
        ...
        bladeNavigationService.closeChildrenBlades(blade, function () {
            ...
            if (node.children) {
                ...
                var newBlade = {
                    ...
                    controller: 'sdl.management.settingsDetailController',
                    template: 'templates/settings/blades/settings-detail.tpl.html'
                };
