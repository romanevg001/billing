...
.controller('sdl.management.settingsDetailController',
    ['$scope', 'sdl.management.dialogService', 'sdl.management.settings.helper',
        'sdl.management.bladeNavigationService', 'sdl.management.settings',
        function ($scope, dialogService, settingsHelper, bladeNavigationService, settings) {
